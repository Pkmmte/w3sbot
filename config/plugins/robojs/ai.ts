...
export const config: PluginOptions = {
	...
	whitelist: {
		channelIds: ['1161149543967101031', '1188607424832229386']
	},
	mcpServers: [
		{
			type: 'mcp',
